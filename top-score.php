            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="top-score.php"><b>Top Score</b></a></li>
                    </ul>
                </div>
            </div>
        </nav>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                                ...
                                if (isset($_POST['submit']) && isset($_POST['league_id'])) {
                                    ...
                                    $url_leagues = "https://apiv3.apifootball.com/?action=get_topscorers&league_id=$leagueId&APIkey=$APIkey";
                                    ...
                                    foreach ($leagues as $league) {
                                        echo '<tr>';
                                        echo '<td>' . $league['player_place'] . '</td>';
                                        echo '<td>' . $league['player_name'] . '</td>';
                                        echo '<td>' . $league['team_name'] . '</td>';
                                        echo '<td>' . $league['goals'] . '</td>';
                                        echo '<td>' . $league['penalty_goals'] . '</td>';
                                        echo '</tr>';
